...
const EditConference = (props) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async values => {
            ...
            context.setEditData({
                ...
                OldProceeding: context.targetPublication,
    ...
    if (context.callEditConference == false) {
        ...
        <>
            ...
            <Confirmtion message={context.warningMessage} url={props.backUrl} editUrl='conference/editConference' />
            {/* <!-- Overlay element --> */}
            ...
            <div id='container' className=" flex fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 z-40  bg-white rounded-lg shadow-2xl p-10 w-[60%]  ">
                ...
                <div className="h-[700px] bg-gradient-to-br from-[#7e22ce] to-[#a26bcd] w-[350px] border-white rounded-lg shadow-lg ">
                    ...
                    <p className="text-4xl tracking-wider text-left mt-10 p-10 text-white font-bold">Share your <br /> updated conference with us</p>
                ...
                <div className="bg-white h-[700px] w-[500px] ">
                    <div className='mt-5 p-10 mb-0'><p className='text-left text-4xl font-bold tracking-wide text-[#7e22ce]'>Edit Conferences</p>
                        <p className='mt-2 text-sm tracking-wide text-left font-semibold'>Already edited conference?<Link to='/journalDetails'><span className="text-[#7e22c3]">Return</span></Link></p>
                    ...
                    <div className='-mt-8 p-10 '>
                        ...
                        <form onSubmit={formik.handleSubmit}>
                            ...
                            <label htmlFor='proceeding' className='float-left text-[#7e22ce] font-bold' >Proceeding</label><br />
                            <input type='text' className='rounded border-2 border-[#7e22c3] float-left mt-1 w-[70%]' name='proceeding' onBlur={formik.handleBlur} onChange={formik.handleChange} value={formik.values.proceeding} ></input>
                            {formik.errors.proceeding && formik.touched.proceeding ? <span className='text-red-400 text-left'>{formik.errors.proceeding}</span> : null}
                            <br /><br />
