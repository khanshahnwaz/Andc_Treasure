...
const PublicationState = (props) => {
    ...
    return (
        <PublicationContext.Provider value={{ warningMessage: warningMessage, setWarningMessage: setWarningMessage, targetId: targetId, setTargetId: setTargetId, goAhead: goAhead, setGoAhead: setGoAhead, callEditBook: callEditBook, setCallEditBook: setCallEditBook, callEditJournal: callEditJournal, setCallEditJournal: setCallEditJournal, callEditConference: callEditConference, setCallEditConference: setCallEditConference, editData: editData, setEditData: setEditData, targetPublication: targetPublication, setTargetPublication: setTargetPublication, callDeleteBook: callDeleteBook, setCallDeleteBook: setCallDeleteBook, callDeleteJournal: callDeleteJournal, setCallDeleteJournal: setCallDeleteJournal, callDeleteConference: callDeleteConference, setCallDeleteConference: setCallDeleteConference, successMessage: successMessage, setSuccessMessage: setSuccessMessage, errorMessage: errorMessage, setErrorMessage: setErrorMessage, addBook: addBook, setAddBook: setAddBook, addJournal: addJournal, setAddJournal: setAddJournal, addConference: addConference, setAddConference: setAddConference,callDetailedPublication:callDetailedPublication,setCallDetailedPublication:setCallDetailedPublication }}>
            {props.children}
